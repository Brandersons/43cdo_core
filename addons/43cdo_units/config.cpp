class CfgPatches
{
    class 43cdo_units
    {
        ...
        units[] = {
            "43cdo_units_soldier_qm",
            "43cdo_units_soldier_zeus",
            "43cdo_units_soldier_31ic",
...
{   
    ...
    class 43cdo_units_soldier_zeus : 43cdo_units_soldier_base
    {
        scope = 2;
        displayName = "Zeus";
        editorSubcategory = "43cdo_faction_edsubcat_playersqm";
    ...
    class 43cdo_units_soldier_31ic : 43cdo_units_soldier_base
    {
        scope = 2;
        displayName = "IC";
        editorSubcategory = "43cdo_faction_edsubcat_playersqm";
    ...
    class 43cdo_units_soldier_medic : 43cdo_units_soldier_base
    {
        scope = 2;
        displayName = "Medic";
        editorSubcategory = "43cdo_faction_edsubcat_playersqm";
    ...
    class West {
        class 43cdo_faction_edcat {
            ...
            class 43cdo_faction_group_infantry {
                ...
                // remember that when setting up unit0 > unit5 that the counting starts at 0, not 1
                class 43cdo_faction_group_31cd {
                    ...
                    class Unit0 {
                        side = 1;
                        vehicle = "43cdo_units_soldier_31ic";
                        rank = "SERGEANT";
                        position[] = {0, 0, 0};
                    };
                    class Unit1 {
