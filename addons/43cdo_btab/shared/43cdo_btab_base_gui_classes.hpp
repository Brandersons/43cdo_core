...
class 43cdo_btab_RscStructuredText
{
	access = 0;
	type = 13;
	idc = -1;
...
class 43cdo_btab_RscShortcutButton
{
	type = 16;
	x = 0.1;
	y = 0.1;
...
class 43cdo_btab_RscShortcutButtonMain
{
	idc = -1;
	style = 0;
	default = 0;
...
class 43cdo_btab_RscButtonMenu
{
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
...
class 43cdo_btab_RscButtonMenuOK
{
	idc = 1;
	shortcuts[] =
	{
...
class 43cdo_btab_RscButtonMenuCancel
{
	idc = 2;
	shortcuts[] =
	{
...
class 43cdo_btab_RscControlsGroup
{
	class VScrollbar
	{
		color[] =
...
class 43cdo_btab_RscMapControl
{
  access = 0;
  idc = -1;
  type = CT_MAP_MAIN;
...
class 43cdo_btab_MenuItem: 43cdo_btab_ActiveText
{
	colorActive[] = {255/255,165/255,0/255,1};
};

class 43cdo_btab_MenuExit: 43cdo_btab_MenuItem
{
	color[] = {1,1,1,0.75};
};
