...
class 43cdo_btab_Mail_ico_disp {
	idd = 13672;
	name=__43cdo_btabMailico;
	onLoad = "uiNamespace setVariable ['43cdo_btab_Mail_ico_disp', _this select 0]";
	fadein = 0;
	fadeout = 0;
	duration = 10e10;
	controlsBackground[] = {};
	...
	class controls {
		class trin_image {
			...
			w = GUI_GRID_W;
			h = GUI_GRID_H;
			text = "\43cdo_btab\img\icon_mail_ca.paa";
		};
	};
}; 