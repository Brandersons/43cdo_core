/*
 	Name: 43cdo_btab_fnc_unitInEnabledVehicleSeat
	...
	Parameters:
 	...
 	Example:
		_playerHasCtabItem = [player,["Item43cdo_btab","ItemAndroid","ItemMicroDAGR"]] call 43cdo_btab_fnc_unitInEnabledVehicleSeat;
*/
...

{
	if (_vehicle isKindOf _x) exitWith {
		call {
			...
			if (_type == "TAD") then {
				if (_unit == _vehicle call 43cdo_btab_fnc_getCopilot) then {_return = true};
			};
		};
	};
