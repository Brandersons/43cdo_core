/*
	Name: 43cdo_btab_fnc_drawUserMarkers
	...
	Example:
		[_ctrlScreen] call 43cdo_btab_fnc_drawUserMarkers;
*/
...
_cursorMarkerIndex = if (_this select 1) then {[_ctrlScreen,cTabMapCursorPos] call 43cdo_btab_fnc_findUserMarker} else {-1};
{
