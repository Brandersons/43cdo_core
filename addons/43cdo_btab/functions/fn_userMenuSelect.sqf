/*
	Name: 43cdo_btab_fnc_userMenuSelect
	...
	Example:
		[1] call 43cdo_btab_fnc_userMenuSelect;
*/
...
call {
	...
	if (_type == 1) exitWith {
		...
		[call 43cdo_btab_fnc_getPlayerEncryptionKey,cTabUserSelIcon] call 43cdo_btab_fnc_addUserMarker;
	};
	
	// Lock UAV cam to clicked position
	if (_type == 2) exitWith {
		[cTabUserSelIcon select 0] call 43cdo_btab_fnc_lockUavCamTo;
	};
