/*
 	Name: 43cdo_btab_fnc_getSettings
	...
	(If parameter 1 is specified)
 	...
 	Example:
		...
		["cTab_Tablet_dlg"] call 43cdo_btab_fnc_getSettings;
		
		// Return available map types for Tablet
		["cTab_Tablet_dlg","mapTypes"] call 43cdo_btab_fnc_getSettings;
*/
...
if (count _this == 2) exitWith {
	_value = [_groupProperties,_property] call 43cdo_btab_fnc_getFromPairs;
	if (isNil "_value") then {
		_value = [_commonProperties,_property] call 43cdo_btab_fnc_getFromPairs;
	};
