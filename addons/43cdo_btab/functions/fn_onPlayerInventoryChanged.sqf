/*
	Name: 43cdo_btab_fnc_onPlayerInventoryChanged
	...
	Example:
		[ACE_player,[player] call ace_common_fnc_getAllGear] call 43cdo_btab_fnc_onPlayerInventoryChanged;
*/
...
if (_playerLostDevice) then {[] call 43cdo_btab_fnc_close};
